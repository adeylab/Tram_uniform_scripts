...
figure <- ggarrange(plotlist=myplots, ncol = 1, nrow = length(myplots),align = "v")
ggsave(plot=figure,file=paste0(gene_name,"_expression_vs_accessibilty_clsassic_select_sites.png"),height=6,width=18,dpi = 600,units = "cm")
ggsave(plot=figure,file=paste0(gene_name,"_expression_vs_accessibilty_clsassic_select_sites.pdf"),height=6,width=18,units = "cm")
}
}
```
...
which_gene=RNA_ATAC_master_up[RNA_ATAC_master_up$site=="chr10_3689885_3690385_CA_0.1836",]
which_gene=RNA_ATAC_master_up[RNA_ATAC_master_up$site=="chr8_123877943_123883529_CA_-0.3880",]
which_gene=RNA_ATAC_master_up[RNA_ATAC_master_up$site=="chr1_153081716_153082216_CA_0.4687",]
which_gene=RNA_ATAC_master_up[RNA_ATAC_master_up$site=="chr14_69242453_69242953_CA_0.1531",]
...
which_gene=RNA_ATAC_master_down[RNA_ATAC_master_down$site=="chr11_65851061_65860777_CA_0.2054",]
